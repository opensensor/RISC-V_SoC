module peri_apb_conn (
    ...
    apb_intf.master nna_apb     // OVIS-1: NNA at offset 0x3000 (addr[13:12]=11)
);

// Address decode: [13:12]
// 00 = UART  (0x10000000)
...
assign uart_apb.psel    = (peri_sel == 2'b00) && peri_apb.psel;
assign uart_apb.penable = (peri_sel == 2'b00) && peri_apb.penable;
...
assign spi_apb.psel     = (peri_sel == 2'b01) && peri_apb.psel;
assign spi_apb.penable  = (peri_sel == 2'b01) && peri_apb.penable;
...
assign mac_apb.psel     = (peri_sel == 2'b10) && peri_apb.psel;
assign mac_apb.penable  = (peri_sel == 2'b10) && peri_apb.penable;
...
assign nna_apb.psel     = (peri_sel == 2'b11) && peri_apb.psel;
assign nna_apb.penable  = (peri_sel == 2'b11) && peri_apb.penable;
assign nna_apb.paddr    =  peri_apb.paddr;
...
always_comb begin
    case (peri_sel)
        ...
        2'b11:   begin peri_apb.prdata = nna_apb.prdata;  peri_apb.pslverr = nna_apb.pslverr;  peri_apb.pready = nna_apb.pready;  end
